...
const STEPS = [
  ...
  },
  {
    num: "02",
    title: "Dil Seç",
    desc: "34 desteklenen dilden kaynak ve hedef dili seçin. AI, konuşmacının ses tonunu ve vurgusunu korur.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const FEATURES = [
  ...
  { title: "34 Dil Desteği", desc: "Avrupa, Asya ve Orta Doğu dilleri" },
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-gray-500 max-w-xl mx-auto mb-8 sm:mb-10 leading-relaxed">
              Videolarınızı AI ile 34 dile çevirin.
